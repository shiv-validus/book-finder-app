...
//       final hasMore =
//           (state is SearchBookLoaded && state.hasMore) ||
...
//         children: [
//           Lottie.asset(
//             'assets/lottie/search_book.json',
//             height: 140,
...
//           Text(
//             'Start typing to find great books',
...
//                     _controller.clear();
//                     _didTriggerAutoLoad = false;
//                     context.read<SearchBookBloc>().add(
//                       const SearchBookQueryChanged(''),
//                     );
//                   },
//                 ),
//               ),
...
//                     state is SearchBookLoadingMore) {
...
//                       _didTriggerAutoLoad = false;
//                       context.read<SearchBookBloc>().add(
//                         SearchBookQueryChanged(_controller.text.trim()),
//                       );
//                     },
